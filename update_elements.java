...
public class update_elements {
    ...
    public update_elements(String table_name, String table_condition, String value_conditional,String... update_columns) {
    ...
    public String getValuesAsString() {
        ...
        return building.toString(); // Return the joined string
    }
    ...
    public void update_element_in_database() {
